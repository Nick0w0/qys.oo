<template>
	<view class="content">
		...
		<view class="filter-box margin bg-white padding radius">
			<input class="cu-form-input margin-bottom-sm" v-model="cityKeyword" placeholder="按城市筛选，如：杭州" />
			<input class="cu-form-input margin-bottom-sm" v-model="keyword" placeholder="搜索学校名称或简称" @confirm="fetchSchools" />
			<view class="flex justify-between align-center margin-top-sm">
				<button class="cu-btn line-purple" @click="useCurrentCity">使用定位城市</button>
				<button class="cu-btn bg-gradual-purple" @click="fetchSchools">搜索</button>
			</view>
		</view>
